...
var file_club_club_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0x9e,
	...
	0x32, 0xf7, 0x11, 0x0a, 0x04, 0x63, 0x6c, 0x75, 0x62, 0x12, 0x57, 0x0a, 0x0c, 0x63, 0x72, 0x65,
	...
	0x6e, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x12, 0x7b, 0x0a, 0x18, 0x67, 0x65, 0x74, 0x4a, 0x6f,
	...
	0x4f, 0x70, 0x65, 0x6e, 0x49, 0x4d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x63, 0x6c, 0x75,
	0x62, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x43, 0x61, 0x63, 0x68, 0x65, 0x52, 0x65, 0x73, 0x70, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69,
...
var file_club_club_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_club_club_proto_goTypes = []interface{}{
	...
	(*ServerApplicationResponseReq)(nil),  // 42: OpenIMServer.club.ServerApplicationResponseReq
	(*ServerApplicationResponseResp)(nil), // 43: OpenIMServer.club.ServerApplicationResponseResp
	(*sdkws.ServerFullInfo)(nil),          // 44: OpenIMServer.sdkws.ServerFullInfo
	(*sdkws.GroupCategoryListInfo)(nil),   // 45: OpenIMServer.sdkws.GroupCategoryListInfo
	(*sdkws.RequestPagination)(nil),       // 46: OpenIMServer.sdkws.RequestPagination
	(*sdkws.ServerMemberFullInfo)(nil),    // 47: OpenIMServer.sdkws.ServerMemberFullInfo
	(*sdkws.ServerInfo)(nil),              // 48: OpenIMServer.sdkws.ServerInfo
...
var file_club_club_proto_depIdxs = []int32{
	44, // 0: OpenIMServer.club.GetServerRecommendecListResp.servers:type_name -> OpenIMServer.sdkws.ServerFullInfo
	44, // 1: OpenIMServer.club.GetServerDetailsResp.server:type_name -> OpenIMServer.sdkws.ServerFullInfo
	45, // 2: OpenIMServer.club.GetServerDetailsResp.categoryList:type_name -> OpenIMServer.sdkws.GroupCategoryListInfo
	46, // 3: OpenIMServer.club.GetServerMemberListReq.pagination:type_name -> OpenIMServer.sdkws.RequestPagination
	47, // 4: OpenIMServer.club.GetServerMemberListResp.members:type_name -> OpenIMServer.sdkws.ServerMemberFullInfo
	47, // 5: OpenIMServer.club.GetServerMembersInfoResp.members:type_name -> OpenIMServer.sdkws.ServerMemberFullInfo
	46, // 6: OpenIMServer.club.GetJoinedServerListReq.pagination:type_name -> OpenIMServer.sdkws.RequestPagination
	48, // 7: OpenIMServer.club.GetJoinedServerListResp.servers:type_name -> OpenIMServer.sdkws.ServerInfo
	46, // 8: OpenIMServer.club.GetServerMembersCMSReq.pagination:type_name -> OpenIMServer.sdkws.RequestPagination
	47, // 9: OpenIMServer.club.GetServerMembersCMSResp.members:type_name -> OpenIMServer.sdkws.ServerMemberFullInfo
	49, // 10: OpenIMServer.club.SetServerMemberInfo.nickname:type_name -> OpenIMServer.protobuf.StringValue
	49, // 11: OpenIMServer.club.SetServerMemberInfo.faceURL:type_name -> OpenIMServer.protobuf.StringValue
	50, // 12: OpenIMServer.club.SetServerMemberInfo.roleLevel:type_name -> OpenIMServer.protobuf.Int32Value
	49, // 13: OpenIMServer.club.SetServerMemberInfo.ex:type_name -> OpenIMServer.protobuf.StringValue
	29, // 14: OpenIMServer.club.SetServerMemberInfoReq.members:type_name -> OpenIMServer.club.SetServerMemberInfo
	47, // 15: OpenIMServer.club.GetUserInServerMembersResp.members:type_name -> OpenIMServer.sdkws.ServerMemberFullInfo
	47, // 16: OpenIMServer.club.GetServerMemberRoleLevelResp.members:type_name -> OpenIMServer.sdkws.ServerMemberFullInfo
	47, // 17: OpenIMServer.club.GetServerMemberCacheResp.member:type_name -> OpenIMServer.sdkws.ServerMemberFullInfo
	46, // 18: OpenIMServer.club.GetJoinedServerGroupListReq.pagination:type_name -> OpenIMServer.sdkws.RequestPagination
	51, // 19: OpenIMServer.club.GetJoinedServerGroupListResp.groups:type_name -> OpenIMServer.sdkws.GroupInfo
	1,  // 20: OpenIMServer.club.club.createServer:input_type -> OpenIMServer.club.CreateServerReq
	5,  // 21: OpenIMServer.club.club.getServerRecommendedList:input_type -> OpenIMServer.club.GetServerRecommendedListReq
	7,  // 22: OpenIMServer.club.club.getServerDetails:input_type -> OpenIMServer.club.GetServerDetailsReq
	25, // 23: OpenIMServer.club.club.joinServer:input_type -> OpenIMServer.club.JoinServerReq
	27, // 24: OpenIMServer.club.club.quitServer:input_type -> OpenIMServer.club.QuitServerReq
	9,  // 25: OpenIMServer.club.club.batchDeleteServers:input_type -> OpenIMServer.club.DeleteServerReq
	3,  // 26: OpenIMServer.club.club.createGroupCategory:input_type -> OpenIMServer.club.CreateGroupCategoryReq
	42, // 27: OpenIMServer.club.club.serverApplicationResponse:input_type -> OpenIMServer.club.ServerApplicationResponseReq
	40, // 28: OpenIMServer.club.club.getJoinedServerGroupList:input_type -> OpenIMServer.club.GetJoinedServerGroupListReq
	11, // 29: OpenIMServer.club.club.getServerMemberList:input_type -> OpenIMServer.club.GetServerMemberListReq
	13, // 30: OpenIMServer.club.club.getServerMembersInfo:input_type -> OpenIMServer.club.GetServerMembersInfoReq
	15, // 31: OpenIMServer.club.club.kickServerMember:input_type -> OpenIMServer.club.KickServerMemberReq
	17, // 32: OpenIMServer.club.club.getJoinedServerList:input_type -> OpenIMServer.club.GetJoinedServerListReq
	19, // 33: OpenIMServer.club.club.getServerMembersCMS:input_type -> OpenIMServer.club.GetServerMembersCMSReq
	21, // 34: OpenIMServer.club.club.muteServerMember:input_type -> OpenIMServer.club.MuteServerMemberReq
	23, // 35: OpenIMServer.club.club.cancelMuteServerMember:input_type -> OpenIMServer.club.CancelMuteServerMemberReq
	30, // 36: OpenIMServer.club.club.setServerMemberInfo:input_type -> OpenIMServer.club.SetServerMemberInfoReq
	34, // 37: OpenIMServer.club.club.getUserInServerMembers:input_type -> OpenIMServer.club.GetUserInServerMembersReq
	32, // 38: OpenIMServer.club.club.getServerMemberUserIDs:input_type -> OpenIMServer.club.GetServerMemberUserIDsReq
	36, // 39: OpenIMServer.club.club.GetServerMemberRoleLevel:input_type -> OpenIMServer.club.GetServerMemberRoleLevelReq
	38, // 40: OpenIMServer.club.club.GetServerMemberCache:input_type -> OpenIMServer.club.GetServerMemberCacheReq
	2,  // 41: OpenIMServer.club.club.createServer:output_type -> OpenIMServer.club.CreateServerResp
	6,  // 42: OpenIMServer.club.club.getServerRecommendedList:output_type -> OpenIMServer.club.GetServerRecommendecListResp
	8,  // 43: OpenIMServer.club.club.getServerDetails:output_type -> OpenIMServer.club.GetServerDetailsResp
	26, // 44: OpenIMServer.club.club.joinServer:output_type -> OpenIMServer.club.JoinServerResp
	28, // 45: OpenIMServer.club.club.quitServer:output_type -> OpenIMServer.club.QuitServerResp
	10, // 46: OpenIMServer.club.club.batchDeleteServers:output_type -> OpenIMServer.club.DeleteServerResp
	4,  // 47: OpenIMServer.club.club.createGroupCategory:output_type -> OpenIMServer.club.CreateGroupCategoryResp
	43, // 48: OpenIMServer.club.club.serverApplicationResponse:output_type -> OpenIMServer.club.ServerApplicationResponseResp
	41, // 49: OpenIMServer.club.club.getJoinedServerGroupList:output_type -> OpenIMServer.club.GetJoinedServerGroupListResp
	12, // 50: OpenIMServer.club.club.getServerMemberList:output_type -> OpenIMServer.club.GetServerMemberListResp
	14, // 51: OpenIMServer.club.club.getServerMembersInfo:output_type -> OpenIMServer.club.GetServerMembersInfoResp
	16, // 52: OpenIMServer.club.club.kickServerMember:output_type -> OpenIMServer.club.KickServerMemberResp
	18, // 53: OpenIMServer.club.club.getJoinedServerList:output_type -> OpenIMServer.club.GetJoinedServerListResp
	20, // 54: OpenIMServer.club.club.getServerMembersCMS:output_type -> OpenIMServer.club.GetServerMembersCMSResp
	22, // 55: OpenIMServer.club.club.muteServerMember:output_type -> OpenIMServer.club.MuteServerMemberResp
	24, // 56: OpenIMServer.club.club.cancelMuteServerMember:output_type -> OpenIMServer.club.CancelMuteServerMemberResp
	31, // 57: OpenIMServer.club.club.setServerMemberInfo:output_type -> OpenIMServer.club.SetServerMemberInfoResp
	35, // 58: OpenIMServer.club.club.getUserInServerMembers:output_type -> OpenIMServer.club.GetUserInServerMembersResp
	33, // 59: OpenIMServer.club.club.getServerMemberUserIDs:output_type -> OpenIMServer.club.GetServerMemberUserIDsResp
	37, // 60: OpenIMServer.club.club.GetServerMemberRoleLevel:output_type -> OpenIMServer.club.GetServerMemberRoleLevelResp
	39, // 61: OpenIMServer.club.club.GetServerMemberCache:output_type -> OpenIMServer.club.GetServerMemberCacheResp
