...
type SendSignalMsgReq struct {
	...
	SignalData *sdkws.SignalData `protobuf:"bytes,3,opt,name=signalData,proto3" json:"signalData"`
}
...
type SetRedPacketMsgStatusReq struct {
	...
	Seq            int64  `protobuf:"varint,2,opt,name=seq,proto3" json:"seq"`
	UserID         string `protobuf:"bytes,3,opt,name=userID,proto3" json:"userID"`
	RedPacketID    string `protobuf:"bytes,4,opt,name=redPacketID,proto3" json:"redPacketID"`
	...
	ClaimUserID    string `protobuf:"bytes,7,opt,name=claimUserID,proto3" json:"claimUserID"`
}
